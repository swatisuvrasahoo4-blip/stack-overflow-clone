...
import {
  updateReputation,
} from "../services/reputationServices.js";
...
import {
  getIpLocation,
} from "../services/ipLocationService.js";
...
export const Signup = async (
  ...
  try {
    ...
    // Save the signup device as trusted.
    await trustDevice({
      userId:
        newuser._id,
      deviceId,
      ...
      if (
        ...
        await updateReputation({
          ...
          type:
            "profile_completed",
          reason:
            "Completed all mandatory profile details",
          relatedId:
            updateprofile._id,
        });
  ...
  async (
    ...
    try {
      ...
      return res
        ...
        .json({
          message:
            "Failed to fetch login sessions",
        });
    }
  };
