...
const benefits = [
  {
    ...
    description:
      "increase_your_daily_question_limit",
  ...
  },
  {
    ...
    description:
      "stand_out_with_exclusive_profile_badges",
  ...
  },
  {
    ...
    description:
      "find_answers_faster_with_powerful_filters",
          ...
          return (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gray-900">
                {t(
                  `why_upgrade.benefits.${item.title}.title`
                )}
              </h3>

              <p className="mt-2 text-[15px] leading-7 text-gray-600">
                {t(
                  `why_upgrade.benefits.${item.title}.description`
                )}
              </p>
            </div>
          );
