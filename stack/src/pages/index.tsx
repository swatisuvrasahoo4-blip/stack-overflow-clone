...
export default function Home() {
  ...
  // Restore Trending / Following after refresh
  useEffect(() => {
  ...
  // Restore Questions / Posts from URL
  useEffect(() => {
  if (!router.isReady) return;

  const content = router.query.content;

  if (content === "posts" || content === "questions") {
  ...
  // Load questions and following users
  useEffect(() => {
  ...
  // Restore question scroll position
  useEffect(() => {
